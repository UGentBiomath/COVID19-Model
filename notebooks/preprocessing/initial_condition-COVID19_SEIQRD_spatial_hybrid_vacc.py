...
# prov
if args.agg == 'prov':
    initial_infected = [0.025, 0.01, 0.003, 0.03, 0.01, 0.014, 0.02, 0.016, 0.016, 0.004, 0.005]
# agg
elif args.agg == 'arr':
    initial_infected = [0.010, 0.004, 0.005, 0.022, 0.007, 0.006, 0.004, 0.002, 0.00015, 0.0001,
                        0.003, 0.0008, 0.00065, 0.0013, 0.0005, 0.0035, 0.0008, 0.0005, 0.005, 0.0008,
                        0.0025, 0.00175, 0.004, 0.01, 0.0012, 0.00035, 0.0015, 0.0012, 0.001, 0.0075, # 29
                        0.002, 0.00075, 0.006, 0.0025, 0.001, 0.0007, 0.0003, 0.0005, 0.0007, 0.0005,
                        0.001, 0.003, 0.0006]
