#!/bin/bash
#PBS -N calibrate-COVID19_SEIQRD_hybrid_vacc ## job name
...
chmod +x calibrate-COVID19_SEIQRD_hybrid_vacc.py
...
python calibrate_CORE-COVID19_SEIQRD_hybrid_vacc.py -n_ag ${n_ag} -n_pso ${n_pso} -n_mcmc ${n_mcmc} -e ${enddate} -ID ${identifier} -hpc
