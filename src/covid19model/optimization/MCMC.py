...
def fit_pso(model,data,parNames,states,bounds,draw_fcn=None,samples=None,disp=True,maxiter=30,popsize=10, processes=mp.cpu_count()-1, start_date=None, omega=0.8, phip=0.8, phig=0.8):
    """
    ...
    # -------------------------------------------
    p_hat, obj_fun_val, pars_final_swarm, obj_fun_val_final_swarm = pso.optim(objective_fcns.MLE, bounds, args=(model,data,states,parNames,draw_fcn,samples, start_date), swarmsize=popsize, maxiter=maxiter,
