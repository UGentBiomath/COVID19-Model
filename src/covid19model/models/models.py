...
class COVID19_SEIRD(BaseModel):
    ...
    state_names = ['S', 'E', 'I', 'A', 'M', 'ER', 'C', 'C_icurec','ICU', 'R', 'D','H_in','H_out','H_tot', 'R_hosp']
    ...
    @staticmethod
    def integrate(t, S, E, I, A, M, ER, C, C_icurec, ICU, R, D, H_in, H_out, H_tot, R_hosp,
        ...
        *Deterministic implementation*
        ...
        dR_hosp = (1-m_C)*C*(1/dc_R) + C_icurec*(1/dICUrec)
        
        return (dS, dE, dI, dA, dM, dER, dC, dC_icurec, dICUstar, dR, dD, dH_in, dH_out, dH_tot, dR_hosp)
