...
class make_contact_matrix_function():
    ...
    def policies_all(self, t, states, param, l1, l2, eff_schools, eff_work, eff_rest, eff_home, mentality):
        ...
        t28 = pd.Timestamp('2021-12-24')
        t29 = pd.Timestamp('2021-12-25')

        t30 = pd.Timestamp('2021-12-31')
        t31 = pd.Timestamp('2022-01-01')

        t32 = pd.Timestamp('2022-01-07') # End of Christmass break
        t33 = pd.Timestamp('2022-02-28') # Start of Spring Break
        t34 = pd.Timestamp('2022-03-06') # End of Spring Break
        t35 = pd.Timestamp('2022-04-04') # Start of Easter Break
        t36 = pd.Timestamp('2022-04-17') # End of Easter Break
        t37 = pd.Timestamp('2022-07-01') # Start of summer holidays
