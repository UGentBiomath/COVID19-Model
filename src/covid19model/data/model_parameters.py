...
def get_COVID19_SEIQRD_VOC_parameters(VOCs=['WT', 'abc', 'delta', 'omicron'], pars_dict=None):
    ...
    # waning:
    vaccine_parameters.loc[(
        slice(None), ['partial', 'full', 'boosted']), 'waning'] = 365
