...
def draw_function(param_dict, samples_dict):
    ...
    param_dict['l2'] = np.random.normal(loc=42, scale=0.2*42)
    ...
    param_dict['f_s'] = np.random.uniform(low=0.20, high=0.30)
    # shocks summer 2020 
    param_dict['ratio_c_s'] =  np.random.uniform(low=0.3, high=0.5)
